'''
모듈 : 다른 파이썬 프로그램에서 불러와 사용할 수 있도록
    만든 파이썬 파일로 변수 혹은 함수 등을 모아놓은 것이다.
'''
# 방법1 : 모듈명만 임포트. 이경우 모듈명을 함께 기술해서
#         함수를 호출한다.
import mod1
print("모듈의 함수호출1 :", mod1.add(3,4))
print("모듈의 함수호출2 :", mod1.sub(4,2))

# 방법2 : 이와같이 하면 함수호출시 모듈명을 생략할 수 있다.
from mod1 import add
result = add(3,4)
print("결과 :", result)

#방법3 : 방법2와 동일하지만 모든 함수를 한꺼번에
#        임포트하는방식
from mod1 import *
result1 = add(3,4)
print("결과 :", result1)
